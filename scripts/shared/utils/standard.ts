...
const ERC20_PERMIT_TYPEHASH = convertToHash(
  "Permit(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)"
);
const ERC721_PERMIT_TYPEHASH = convertToHash(
  "Permit(address spender,uint256 tokenId,uint256 nonce,uint256 deadline)"
);
const ERC721_PERMIT_ALL_TYPEHASH = convertToHash(
  "Permit(address owner,address spender,uint256 nonce,uint256 deadline)"
);
const ERC1155_PERMIT_TYPEHASH = convertToHash(
  "Permit(address owner,address spender,uint256 nonce,uint256 deadline)"
);
